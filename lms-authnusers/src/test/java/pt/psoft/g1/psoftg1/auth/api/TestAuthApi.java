...
class TestAuthApi {
    ...
    @Autowired
    public TestAuthApi(final MockMvc mockMvc, final ObjectMapper objectMapper, final UserTestDataFactory userTestDataFactory) {
   ...
   @Test
    ...
    void testRegisterSuccess() throws Exception {
        ...
        assertEquals(goodRequest.getName(),
